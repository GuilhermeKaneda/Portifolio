...
function abrirImagem(url, i) {
    ...
    if(i==0)
        github.href = 'https://github.com/GuilhermeKaneda/Banco-de-Dados';
    else
        github.href = 'https://github.com/GuilhermeKaneda/Projeto01-SistemaEducacional';
